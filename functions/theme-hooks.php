...
function text_layout_manager () {
    ...
    //Team
    if ($mosacademy_options['sections-team-text-layout'] == 'container-fliud-spacing') {
    ...
    } elseif ($mosacademy_options['sections-team-text-layout'] == 'container-fliud') {
        add_action( 'action_before_team', 'start_container_fluid', 10, 1 );
        add_action( 'action_after_team', 'end_div', 10, 1 );
    } elseif ($mosacademy_options['sections-team-text-layout'] == 'container-full') {
...
function team_archive_page_fnc () {
    global $mosacademy_options;
    $members = $mosacademy_options['sections-team-slides'];
    $padding = ($mosacademy_options['sections-team-padding']) ? '' : 'no-padding' ;
    $layout = $mosacademy_options['sections-team-layout'];
    $count = $mosacademy_options['sections-team-count'];
    $n = 1;
