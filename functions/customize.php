...
function mosacademy_customize_register( $wp_customize ){
...
add_action('customize_register', 'mosacademy_customize_register'); 
//Output Customize CSS
function mosacademy_customize_css(){?>
    <style type="text/css">
        a:link,
        a:visited {
...
<?php }
add_action('wp_head', 'mosacademy_customize_css');
