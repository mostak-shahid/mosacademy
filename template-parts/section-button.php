...
$animation = $mosacademy_options['sections-button-animation'];
$animation_delay = $mosacademy_options['sections-button-animation-delay'];
$title = $mosacademy_options['sections-button-title'];
$content = $mosacademy_options['sections-button-content'];
$buttons = $mosacademy_options['sections-button-slides'];
$gap = $mosacademy_options['sections-button-gap'][1];
