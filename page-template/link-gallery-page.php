		...
		<?php if($page_layout != 'ns') : ?>
			...
			<?php endif; ?>
				<?php if ( have_posts() ) :?>	
					...
					$gallery_gap = get_post_meta( get_the_ID(), '_mosacademy_link_gallery_gap', true );
					...
					if($gallery_images) : ?>
						...
						<?php foreach ( $gallery_images as $gallery_image ) : ?>
							<div class="col-md-<?php echo $layout; if ($gallery_gap) echo ' mb30'; else echo ' no-padding'; ?>">
								<?php //echo $gallery_image['_mosacademy_link_gallery_details_text'] . ', ' . $gallery_image['_mosacademy_link_gallery_details_url'] . ', ' . $gallery_image['_mosacademy_link_gallery_details_image_id'] . ', ' . $gallery_image['_mosacademy_link_gallery_details_image'] . '<br />'?>
								<?php
