...
$grid = $mosacademy_options['testimonial-page-grid'];
if($grid == '4') { $colsize = 3; }
...
<section id="testimonial-page" class="page-content">
	<div class="content-wrap">
		...
		*/
		...
		<?php
		$count = ($mosacademy_options['testimonial-page-count']) ? $mosacademy_options['testimonial-page-count'] : '-1' ;
		$args = array(
				...
				while ($query -> have_posts()) : $query -> the_post(); 
					...
					?>
						<div class="col-md-<?php echo $colsize;?>">
			                <div class="testimonial-content<?php if ($mosacademy_options['testimonial-page-content-layout'] == 2) echo ' row' ?>">
			                	<?php
			                	if ($mosacademy_options['testimonial-page-content-layout'] == 2 AND $mosacademy_options['testimonial-page-section1-width']) :
				                	$sec_1 = $mosacademy_options['testimonial-page-section1-width'];
				                	$slice = explode("-",$sec_1);
				                	$num = 12 - end($slice);
			                	...
			                	<?php foreach ($mosacademy_options['testimonial-page-section1'] as $shortcodes) : ?>
			                		<?php echo do_shortcode( $shortcodes ) ?>
			                	<?php endforeach; ?>
			                	</div>
			                	<div class="sec-2 <?php  echo $sec_2 ?>">		                		
			                	<?php foreach ($mosacademy_options['testimonial-page-section2'] as $shortcodes) : ?>
			                		<?php echo do_shortcode( $shortcodes ) ?>
			                	<?php endforeach; ?>
			                	</div>  
			                </div> 
