...
<div class="hidden-md hidden-lg">
    ...
    <div class="small-nav bottom">
        <?php mobile_menu ($mosacademy_options['misc-sticky-layout']['On Footer']);?>
    </div> 
<?php 
        wp_nav_menu( array(
            'menu'              => 'mobilemenu',
...
<?php wp_footer(); ?>
<style><?php echo $mosacademy_options['misc-settings-css'] ?></style>
<script><?php echo $mosacademy_options['misc-settings-js'] ?></script>
</body>
</html>
